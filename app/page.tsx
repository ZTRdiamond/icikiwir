        ...
        <div className="container mx-auto px-6">
          ...
          <div className="mt-16">
            ...
            >
              ...
              <p className="text-[#aaa] mb-6 leading-relaxed">As someone who loves diving into technology, I have a real knack for backend development, managing databases, and creating bots. For the past year, I've been working on all sorts of programming projects involving REST APIs, data-driven apps, and automation systems. I've spent time building and looking after bots using tools like Baileys for WhatsApp, Grammy for Telegram, and Discord.js for Discord. I've put my main focus on making sure these solutions are top-notch, reliable, and capable of scaling up to meet different needs. In addition to that, I have a lot of experience in setting up backend structures, optimizing data flow, and keeping systems running smoothly with clean and structured code.</p>
